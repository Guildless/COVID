...
#define ECC_ACFTeam1Channel  ECollisionChannel::ECC_GameTraceChannel1
#define ECC_ACFTeam2Channel  ECollisionChannel::ECC_GameTraceChannel2
#define ECC_ACFTeam3Channel  ECollisionChannel::ECC_GameTraceChannel3
#define ECC_ACFTeam4Channel  ECollisionChannel::ECC_GameTraceChannel4
#define ECC_ACFNeutralChannel  ECollisionChannel::ECC_GameTraceChannel5
...
public:
	...
	{
		switch (CombatTeam) {
			case ETeam::ETeam1: return ECC_ACFTeam1Channel;
			case ETeam::ETeam2: return ECC_ACFTeam2Channel;
			case ETeam::ETeam3: return ECC_ACFTeam3Channel;
			case ETeam::ETeam4: return ECC_ACFTeam4Channel;
			case ETeam::ENeutral: return ECC_ACFNeutralChannel;
			default: return ECC_ACFTeam1Channel;
		}
	}

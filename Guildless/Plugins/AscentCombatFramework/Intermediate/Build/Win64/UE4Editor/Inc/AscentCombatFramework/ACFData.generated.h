...
#ifdef ASCENTCOMBATFRAMEWORK_ACFData_generated_h
#error "ACFData.generated.h already included, missing '#pragma once' in ACFData.h"
#endif
...
public: \
	DECLARE_CLASS(UACFData, UObject, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/AscentCombatFramework"), NO_API) \
...
#define Guildless_Plugins_AscentCombatFramework_Source_AscentCombatFramework_Public_Game_ACFData_h_547_STANDARD_CONSTRUCTORS \
	...
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, UACFData); \
DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(UACFData); \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	NO_API UACFData(UACFData&&); \
	NO_API UACFData(const UACFData&); \
public:
...
#define FOREACH_ENUM_EABILITYTYPE(op) \
	op(EAbilityType::EActive) \
	op(EAbilityType::EPassive) 
...
#define FOREACH_ENUM_ESPAWNFXLOCATION(op) \
	...
	op(ESpawnFXLocation::ELastDamageLocation) 
...
#define FOREACH_ENUM_EAICOMBATSTATE(op) \
	...
	op(EAICombatState::EMeleePostAttack) \
...
#define FOREACH_ENUM_EDEATHTYPE(op) \
	...
	op(EDeathType::EDestroyImmediately) \

...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UACFDamageWidget_Statics::Class_MetaDataParams[] = {
		{ "Comment", "/**\n * \n */" },
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UACFDamageWidget_Statics::ClassParams = {
		...
		0,
		0x00B010A0u,
		METADATA_PARAMS(Z_Construct_UClass_UACFDamageWidget_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UACFDamageWidget_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_UACFDamageWidget()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UACFDamageWidget_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UACFDamageWidget, 1989435175);
	template<> ASCENTCOMBATFRAMEWORK_API UClass* StaticClass<UACFDamageWidget>()
	{
		return UACFDamageWidget::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UACFDamageWidget(Z_Construct_UClass_UACFDamageWidget, &UACFDamageWidget::StaticClass, TEXT("/Script/AscentCombatFramework"), TEXT("UACFDamageWidget"), false, nullptr, nullptr, nullptr);

...
public:
	...
	FSlateBrush ColorPin = *FCoreStyle::Get().GetBrush("ColorWheel.Selector");
	...
	*/
    ...
    void SetColor(const FLinearColor NewColor) { Color = NewColor;}
	...
	*/
    ...
    FLinearColor GetCurrentColor() { return Color;}
